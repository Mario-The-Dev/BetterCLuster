...
namespace BetterCLuster.Program.use.only.ui
{
    class UI
    {
        ...
        private static string SelectionPrompt(List<string> choices)
        {
        ...
        public static void CommandInputBox() {
            try
            {
                ...
                Console.ForegroundColor = ConsoleColor.Gray;
                Console.WriteLine($"[ Build Name : {Global.Build} v{Global.version} | {isAdminHeader} | Battery Percentage : {BatteryInfo[0]}% ]");
