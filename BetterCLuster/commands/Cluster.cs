...
namespace BetterCLuster.Commands.ClusterExplorer
{
    ...
    public class ClusterExplorerSystem
    {
        ...
        {
            string[] filesAndDirectories = Directory.GetFileSystemEntries(Directory.GetCurrentDirectory());
            List<string> fileAndDirectoryList = new List<string>(filesAndDirectories);
            string selection = UI.SelectionPrompt(null, fileAndDirectoryList);    
        }
    }
}
